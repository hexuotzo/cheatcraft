    ...
    singleAC.prototype = {
        ...
        getOption: function(){
            ...
            return this.optionEl || function(){
                ...
                navItemWrapper.innerHTML = "<li id='alteration'>调节</li><li id='filter'>滤镜</li>";
                ...
                var alterationHandler = function(e){
                    ...
                    var SBar = _this.getScrollBar(80, 0.5, "色　相", "apH", callback);
                    var HBar = _this.getScrollBar(80, 0.5, "饱和度", "apS", callback);
                    var IBar = _this.getScrollBar(80, 0.5, "亮　度", "apI", callback);
                    var DBar = _this.getScrollBar(80, 0.5, "对比度", "apD", callback);
                    ul.appendChild(SBar);
                    ul.appendChild(HBar);
                    ul.appendChild(IBar);
                    ul.appendChild(DBar);
            ...
            return this.rect || function(){
                ...
                window.addEventListener("mousemove", function(e){
                    ...
                    if(controlClickFlag){
                        ...
                        //bottom right
                        var dx = x - currPageX;
                        var dw = y - currPageY;//dx / rectRatio;

                        if(currControlDotI == 3){
                            var width = currWidth + dx;
                            var height = currHeight + dw;//width / rectRatio;
                            ...
                            var height = -dw + currHeight;//width / rectRatio;
                            var left = currLeft + dx;
        ...
        showClipPic: function(){
            ...
            if(clipInfo.height > clipInfo.width){
                //纵向向图片
                var scaleY = this.defaultWidth / clipInfo.height;
                var scaleX = scaleY;
            }else{
                //横向图片
            ...
            //this.downPic = aiLayer.clip(clipInfo.left, clipInfo.top, clipInfo.width, clipInfo.height).clone();
